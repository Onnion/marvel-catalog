...
export const setVariants = ({ id, variants }: { id: number, variants: Image[] }) => action(ComicsTypes.SET_VARIANTS, { id, variants });
...
export const set = (comic: Comic) => action(ComicsTypes.SET, { comic });